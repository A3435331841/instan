...
def run_sequence(seq_rel, data_root, tracker_factory, max_frames=None):
    ...
    for i in range(1, limit):
        ...
        traces.append({
            ...
            "presence_risk": out.get("presence_risk"),
            "presence_probe": bool(out.get("presence_probe", False)),
            "update_blocked_by_presence": bool(out.get("update_blocked_by_presence", False)),
